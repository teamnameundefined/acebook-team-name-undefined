  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Comment" do
        ...
        p @post
        expect {
          post :create, params: {comment: valid_attributes }, post_id: post.id, session: valid_session
        }.to change(Comment, :count).by(1)
      end

      it "redirects to the created comment" do
        post :create, params: {body: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {body: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
